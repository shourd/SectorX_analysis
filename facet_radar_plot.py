...
def main():
    ...
    plt.tight_layout()
    plt.savefig('{}/test_scores/facet_radar_plot_{}.png'.format(settings.output_dir, plot_type), bbox_inches='tight')


def make_spider(model_participant_id, df, radar_type):
